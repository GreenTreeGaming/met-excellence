...
const classes: {
  ...
  },
  {
    ...
    "level": "Anyone!",
    "description": "Help your kids discover the vibrant heart of India from the convenience of your own home! This interactive online class brings Indian culture to life as we walk through the amazing languages, festivals, and traditions. Perfect for all ages, you’ll explore the richness of India’s heritage in fun, hands-on sessions designed to spark curiosity and connection. Join us and experience India like never before!",
  ...
  },
  {
    ...
    tutor: 'Ryan Niu',
    level: 'Advanced',
    description: "Open the door to problem solving and creative thinking through the AMC 8 prep course! We will cover topics from the 4 main topics: Algebra, Number Theory, Geometry, and Combinatorics, in which students will gain a better understanding of new problem solving methods that are not traditionally taught in school. Whether you're a beginner or have already had some experience with competition math, this course will cover the starting basics for students hoping to do well on the AMC 8 and other early math competitions.",
    image: 'amc8.webp',
    status: 'online',
